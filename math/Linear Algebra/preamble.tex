...
\definecolor{stmtcolor}{HTML}{C0C0C0} % Серебряный
...
% Определение цвета для фрейма следствия
\definecolor{corcolor}{HTML}{FFE4E1} % Светло-розовый

% Определение стиля для следствия
\newtheoremstyle{mycorstyle}
  {3pt} % Space above
  {3pt} % Space below
  {} % Body font
  {} % Indent amount
...
\newenvironment{shcor}
  {\def\FrameCommand{\fboxsep=\FrameSep \fcolorbox{black}{corcolor}}\MakeFramed {\FrameRestore}}
  {\endMakeFramed}
